...
const hrImge =
  "https://greystoneinn.com/wp-content/uploads/2021/01/Bridal-Session-0061.1000px.jpg";

export default function WeddingRFP() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Wedding RFP submitted");
  };

  return (
    <div>
      <HeroImage image={hrImge} title="Wedding RFP" />
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-20">
          ...
          <header className="rfp-hero max-w-3xl mb-10 lg:mb-14">
            ...
            <p className="mt-4 text-sm sm:text-base text-slate-700 leading-relaxed">
              Share a few details about your celebration and our weddings team
              will be in touch with tailored options for dates, venues, and
              packages at The Greystone Inn. This form is a starting point
              &mdash; we&apos;ll refine everything together.
            </p>
          </header>
              ...
              >
                ...
                <div className="px-6 py-6 sm:px-8 sm:py-8">
                  ...
                  <p className="text-xs text-slate-600 mb-3">
                    Select any wedding experiences you&apos;d like to learn more
                    about:
                  </p>
                ...
                <div className="px-6 py-6 sm:px-8 sm:py-8">
                  ...
                  <div className="mt-5">
                    ...
                    <textarea
                      ...
                      name="details"
                      rows={5}
                      placeholder="Share anything that will help us tailor your proposal – style, must-have moments, special traditions, etc."
                      className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm outline-none focus:border-[#003d51] focus:ring-1 focus:ring-[#003d51]/60"
                    />
                  </div>
                </div>
                ...
                <div className="px-6 py-5 sm:px-8 sm:py-6 flex flex-col gap-3 border-t border-slate-200 bg-slate-50/80 rounded-b-3xl">
                  <p className="text-xs text-slate-600">
                    ...
                    conversation with our weddings team. Dates and pricing are
            ...
            <aside className="rfp-side-panel space-y-6 lg:space-y-8">
              ...
              <div className="overflow-hidden rounded-3xl border border-slate-200 bg-slate-200/60">
                <div className="relative h-52 sm:h-64 lg:h-72">
                  <img
                    src="https://greystoneinn.com/wp-content/uploads/2021/01/HD9A2565.jpg"
              ...
              <div className="rounded-3xl border border-slate-200 bg-white px-6 py-6 sm:px-7 sm:py-7">
                ...
                <p className="text-sm text-slate-700 leading-relaxed mb-4">
                  ...
                  salons, each wedding at The Greystone Inn is tailored to the
                  couple. Our six curated packages &mdash; including Your
                  Weekend, Buy-Out, Grand Event, Intimate Weddings, Elopements,
                  and Mansion &mdash; are simply starting points.
                </p>
                <p className="text-sm text-slate-700 leading-relaxed">
                  Once we receive your request, a member of our team will
                  personally review your details and reach out with date
                  availability, recommended packages, and next steps for a visit
                  or virtual tour.
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-slate-200 bg-[#003d51] px-6 py-6 sm:px-7 sm:py-7 text-slate-100">
                ...
                <p className="text-sm text-slate-100/90 leading-relaxed mb-4">
                  Our weddings team would be delighted to connect by phone or
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <a
                    ...
                    className="block underline underline-offset-2 decoration-slate-200/70 hover:decoration-white"
                  >
                    weddings@example.com
                  </a>
                  <a
                    href="#"
                    className="mt-2 inline-block text-xs uppercase tracking-[0.2em] border border-slate-100/70 rounded-full px-4 py-1.5 hover:bg-slate-100 hover:text-[#003d51] transition-colors"
                  >
