...
export default function StaggeredGallery({
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate overflow-hidden py-16 bg-[#003D51]  md:py-24"
    >
      {/* Background flourish */}
      <div
      ...
      <div className="mx-auto max-w-6xl px-4 ">
        ...
        <div className="sg-heading mb-10 max-w-2xl md:mb-14">
          ...
          <h2 className="text-3xl uppercase font-semibold leading-tight text-neutral-900 md:text-4xl dark:text-white">
            {title}
          </h2>
          {text && (
            <p className="mt-3 text-base leading-relaxed text-neutral-600 md:mt-4 dark:text-neutral-300">
              {text}
            </p>
          )}
          <NavGhostBtn title="Learn More" link={link} />
        </div>
